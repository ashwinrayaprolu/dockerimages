...
docker run --rm -u gradle -v maven-local-cache:/home/gradle/.m2/ -v gradle-cache:/home/gradle/.gradle -v "$PWD":/home/gradle/project -w /home/gradle/project thoughtlane/jdk-12.0.1_12 gradle clean build -x test
